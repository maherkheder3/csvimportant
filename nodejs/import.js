...
var path = "/var/www/html/importcsvfile/Artikeldaten-Shop-short.csv";
...
function result_date(cn){
    if(isNaN(cn) || cn == null || cn === "" || cn === "0" || cn === " ")
    {
        return null;
    }
...
function get_last_prise(row)
{
    ...
    {
        return row["VKPREIS2"].replace(",", ".");
    }
    else{
        return row["VKPREIS1"].replace(",", ".");
    }
}
